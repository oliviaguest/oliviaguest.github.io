...
<ul class="cv">
  ...
  <li class="cv">
    ...
    <b>Guest, O.</b>, Love, B. C. (in press). What the Success of Brain Imaging Implies about the Neural Code. <em>eLife</em>.
